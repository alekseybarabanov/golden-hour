...
> Бот `@your_notes_bot` (id `100000000`) — рабочий production-инстанс у Karim'а. Этот пакет — 1:1 слепок его runtime + полный набор инструкций, чтобы любой другой пользователь OpenClaw мог развернуть такой же бот у себя, вставив только токен от @BotFather.
...
- **Прообраз:** production-бот @your_notes_bot (id `100000000`)
- **Автор:** Karim
