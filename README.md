...
>
> **Документация:** [docs/](docs/README.md) — исчерпывающий разбор проекта: архитектура, ядро агента, модель данных, скиллы, скрипты, дашборд, деплой, интеграции, безопасность.
