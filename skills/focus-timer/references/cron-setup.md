...
The focus-timer skill needs 4 cron jobs to reset the 4 windows at their boundaries. These are agentTurn crons that read `state/stats.json` and zero out the appropriate window.
